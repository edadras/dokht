...
abstract class BaseCuff extends DetailStyle
{
    ...
    public function supports(array $pieces, array $context): true|string
    {
        ...
        // مچ سر آستین را کوتاه می‌کند و دم آستین را با پیلی یا چین به اندازه خودش
        // می‌رساند؛ اجرای دوباره آستین را دو بار کوتاه می‌کند و مچ دوم روی مچ اول
        // می‌افتد. یک آستین بیش از یک مچ ندارد، پس بار دوم رد می‌شود.
        if ($this->hasPart($pieces, 'cuff') || $this->alreadyApplied($pieces)) {
            return 'سر آستین این لباس از پیش مچ دارد و یک آستین بیش از یک مچ نمی‌گیرد؛ '
                .'برای گذاشتن «'.$this->label().'» اول مچ کنونی را از فهرست سبک‌ها بردارید.';
        }
