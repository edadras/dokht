 ...
 *     وقتی چنین قطعه‌ای نیست یا آستین دیگری در کار است.
 *   - درآوردن نقطه‌های تکیه (مرکز یقه، سرگردن، نوک سرشانه، زیر بغل) از هر بالاتنه‌ای،
 *     چه حلقه‌اش یک لبه باشد چه چند لبه پشت سر هم.
 ...
 *   - کشیدن یک درز با «طول دقیق خواسته‌شده» بین دو نقطه و پیداکردن نقطه‌ای که از دو
 *     نقطه دیگر فاصله معلوم دارد (کار پرگار خیاط) — هسته جورشدن درزهای رگلان و سدل.
 */
