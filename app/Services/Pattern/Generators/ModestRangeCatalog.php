...
class ModestRangeCatalog extends CatalogVariantBase
{
    ...
    protected const ROBES = [
        ...
        // تونیکِ پوشیده فقط آستینِ دوخته‌شده دارد؛ حلقهٔ بازش را درفت نمی‌شناسد
        'tunic' => ['تونیک پوشیده', 'trad_modest_tunic', [34, 42, 58], true, ['short', 'long']],
        // این دو یقهٔ ایستادهٔ ثابت دارند و آن بخشی از هویتشان است
        'qipao' => ['چیپائو', 'trad_qipao', [58, 72, 95], false],
        'shalwar' => ['شلوار کمیض', 'trad_shalwar_kameez', [42, 52, 68], false],
    ];
