...
trait BodiceCatalogSupport
{
    ...
    protected function sideEdge(array $s): array
    {
        ...
        /*
         * کمرگیری از اختلافِ چارکِ سینه تا چارکِ کمر می‌آید: هرچه سینه از کمر
         * بزرگ‌تر باشد، بخشی روی درز پهلو و بخشی در ساسون گرفته می‌شود. سازوکارش
         * فقط *کم* می‌کند.
         *
         * روی اندام سیبی که کمرش از سینه‌اش بزرگ‌تر است، آن اختلاف صفر می‌شود و
         * درز پهلو روی چارکِ سینه می‌ماند — از کمر تنگ‌تر. آن‌وقت لبهٔ کمرِ
