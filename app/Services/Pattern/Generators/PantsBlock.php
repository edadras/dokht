...
trait PantsBlock
{
    ...
    protected function legPanel(array $mx, array $o = []): array
    {
        ...
        /*
         * لبهٔ کمر از پهنای باسن می‌آید منهای کاهش‌ها — یعنی هیچ‌وقت از باسن
         * پهن‌تر نمی‌شود. برای بیشترِ بدن‌ها درست است، چون کمر از باسن باریک‌تر
         * است. ولی اندام سیبی کمرش از باسنش بزرگ‌تر است و آن‌وقت شلوار هرچه
         * حساب می‌کرد، لبهٔ کمرش روی پهنای باسن گیر می‌کرد و به هدف خودش
         * نمی‌رسید: روی سرهمی، کمرِ پاچه سه سانتی‌متر از کمرِ بالاتنه‌ای که به
         * آن دوخته می‌شود کوچک‌تر درمی‌آمد.
         *
