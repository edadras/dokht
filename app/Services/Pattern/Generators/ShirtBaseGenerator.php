    ...
    protected function shirtCollar(float $halfNeck, float $height, string $code = 'collar', string $name = 'یقه'): array
    {
        ...
        return $this->piece([
            ...
            'meta' => [
                ...
                /*
                 * خطِ خوابِ یقه: از این خط به بالا برمی‌گردد و می‌خوابد.
                 *
                 * یقهٔ یک‌تکه (پایه و رویه در یک قطعه) روی خطی حدوداً سه
                 * سانتی‌متر از خط یقه تا می‌شود — همان بلندیِ پایهٔ یقه. نمای
                 * سه‌بعدی بی این عدد هیچ دلیلی برای تا کردن ندارد و یقه راست
                 * می‌ایستد؛ اندازه گرفته شد، لبهٔ بیرونی ۵٫۷ سانتی‌متر از گردن
                 * فاصله می‌گرفت و نوکش بیرون می‌زد.
                 */
                'roll_line' => round(min(3.0, $height * 0.45), 2),
                'fold_edges' => [3],
