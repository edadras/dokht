...
class DrapePayloadService
{
     ...
     * سرِ آستین در حلقه بماند. حالا که هُلی در کار نیست، ربعِ راه بس است: سرِ
     * آستین نزدیک‌ترِ حلقه چیده می‌شود و درز راهِ کمتری برای بستن دارد.
     */
    protected const SLEEVE_LIFT = 0.25;
