...
import { anchorTargets } from '../lib/pattern-drape.js';
...
export const shoulderAnchors = (drape, table, payload) => {
    ...
    // همان سنجاق‌هایی که چیدن نشانده؛ ببینید anchorTargets در pattern-drape.js
    return anchorTargets(drape.patches, table, payload, payload.scale ?? 0.01);
};
